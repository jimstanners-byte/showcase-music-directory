...
"[project]/showcase-next/src/components/ListingsMap.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ListingsMap(param) {
    let { listings, selectedListing, onSelectListing, highlightedListingId, onBoundsChange, initialState, resetTrigger } = param;
    _s();
    ...
    const [internalSelectedListing, setInternalSelectedListing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const ensurePopupVisible = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsMap.useCallback[ensurePopupVisible]": (lng, lat)=>{
    ...
    }["ListingsMap.useCallback[ensurePopupVisible]"], []);
    // Filter listings with valid coordinates
    const mappableListings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ListingsMap.useMemo[mappableListings]": ()=>listings.filter({
                "ListingsMap.useMemo[mappableListings]": (l)=>l.latitude !== null && l.longitude !== null
            }["ListingsMap.useMemo[mappableListings]"])
    }["ListingsMap.useMemo[mappableListings]"], [
        listings
    ]);
    ...
    const supercluster = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ListingsMap.useMemo[supercluster]": ()=>{
            ...
            const points = mappableListings.map({
                "ListingsMap.useMemo[supercluster].points": (listing)=>({
                        type: "Feature",
                        properties: {
                            id: listing.id,
                            listing
            ...
            }["ListingsMap.useMemo[supercluster].points"]);
            cluster.load(points);
            return cluster;
        }
    }["ListingsMap.useMemo[supercluster]"], [
    ...
    const highlightedClusterId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ListingsMap.useMemo[highlightedClusterId]": ()=>{
            ...
            const isIndividualMarker = clusters.some({
                "ListingsMap.useMemo[highlightedClusterId].isIndividualMarker": (cluster)=>{
                    var _props_listing;
                    const props = cluster.properties;
                    return !props.cluster && ((_props_listing = props.listing) === null || _props_listing === void 0 ? void 0 : _props_listing.id) === highlightedListingId;
                }
            }["ListingsMap.useMemo[highlightedClusterId].isIndividualMarker"]);
            ...
            for (const cluster of clusters){
                ...
                if (props.cluster) {
                    ...
                    const containsListing = leaves.some({
                        "ListingsMap.useMemo[highlightedClusterId].containsListing": (leaf)=>leaf.properties.id === highlightedListingId
                    }["ListingsMap.useMemo[highlightedClusterId].containsListing"]);
                    if (containsListing) {
    ...
    const initialBounds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ListingsMap.useMemo[initialBounds]": ()=>{
            if (mappableListings.length === 0) return null;
            const lats = mappableListings.map({
                "ListingsMap.useMemo[initialBounds].lats": (l)=>l.latitude
            }["ListingsMap.useMemo[initialBounds].lats"]);
            const lngs = mappableListings.map({
                "ListingsMap.useMemo[initialBounds].lngs": (l)=>l.longitude
            }["ListingsMap.useMemo[initialBounds].lngs"]);
            return {
    ...
    const prevBoundsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const prevResetTrigger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const onMapLoad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsMap.useCallback[onMapLoad]": ()=>{
            if (!mapRef.current) return;
            const map = mapRef.current;
    ...
    const onMoveEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsMap.useCallback[onMoveEnd]": ()=>{
            if (!mapRef.current) return;
            const map = mapRef.current;
            const mapBounds = map.getBounds();
    ...
    const handleClusterClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsMap.useCallback[handleClusterClick]": (clusterId, clusterLng, clusterLat)=>{
            if (!mapRef.current) return;
            ...
            const lngs = leaves.map({
                "ListingsMap.useCallback[handleClusterClick].lngs": (l)=>l.geometry.coordinates[0]
            }["ListingsMap.useCallback[handleClusterClick].lngs"]);
            const lats = leaves.map({
                "ListingsMap.useCallback[handleClusterClick].lats": (l)=>l.geometry.coordinates[1]
            }["ListingsMap.useCallback[handleClusterClick].lats"]);
    ...
    }["ListingsMap.useCallback[handleClusterClick]"], [
        supercluster
    ]);
                ...
                actualSelectedListing && actualSelectedListing.latitude && actualSelectedListing.longitude && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$react$2d$map$2d$gl$2f$dist$2f$esm$2f$exports$2d$maplibre$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Popup"], {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            actualSelectedListing.town_city && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$showcase$2d$next$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: "/listing/".concat(actualSelectedListing.slug),
...
_s(ListingsMap, "n/otyIzt8fUcft+UO84MySthDyg=");
_c = ListingsMap;
...
//# sourceMappingURL=showcase-next_src_components_ListingsMap_tsx_3d066a12._.js.map