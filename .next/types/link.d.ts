...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    ...
    | `/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/listing/${SafeSlug<T>}`
    | `/news/${SafeSlug<T>}`
    | `/venues/${SafeSlug<T>}`
    | `/venues/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/venues/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/venues/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/venues/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}/${SafeSlug<T>}`
